...
public class TreeSpell implements Spell{
	...
	public MaterialData[] getIngredients() {
		return new MaterialData[]{new MaterialData(Material.LOG, (byte) 2), new MaterialData(Material.LOG, (byte) 3), new MaterialData(Material.LOG), new MaterialData(new Dye(DyeColor.BROWN).getItemType()), new MaterialData(Material.LOG_2), new MaterialData(Material.SAPLING, (byte) 1), new MaterialData(Material.SAPLING, (byte) 5)};
	}
